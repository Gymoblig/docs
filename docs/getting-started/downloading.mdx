...
There are few reason why it may happen, but most common is that you are using adblocker. Please disable it and try again. Other reason might be your antivirus and it's web protection. Just simply disable this feature for a while and when the launcher will be downloaded you can turn it back on.
